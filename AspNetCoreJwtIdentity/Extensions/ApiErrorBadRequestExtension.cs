...
{
    public static class ApiErrorBadRequestExtension
    {
        public static BadRequestObjectResult BadRequest(this ApiError apiError, ILogger logger, object? parameters = null, string? errorMessage = null)
        {
